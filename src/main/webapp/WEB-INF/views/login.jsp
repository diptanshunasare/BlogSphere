...
<title>Login Form validation in HTML and CSS | CodingNepal</title>
...
<body>
    ...
    %>
		...
		<form action="./login" method="post">
			<div class="field email">
				<div class="input-area">
					<input type="email" name="email" placeholder="Email Address"> <i
						class="icon fas fa-envelope"></i>
				</div>
			</div>
			<div class="field password">
				<div class="input-area">
					<input type="text" name="password" placeholder="Password"> <i
		...
		<div class="sign-txt">
			Not yet member? <a href="sign-up">Signup now</a>
		</div>
	</div>
